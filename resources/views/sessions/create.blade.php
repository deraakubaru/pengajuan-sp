                            ...
                            <div class="card z-index-0 fadeIn3 fadeInBottom">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-info shadow-primary border-radius-lg py-3 pe-1">
                                        <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Semester Pendek</h4>
                                        <h6 class="text-white font-weight-bolder text-center mt-2 mb-0">Institut Digital Ekonomi LPKIA</h6>
                                    </div>
                                </div>
                                <div class="card-body">
